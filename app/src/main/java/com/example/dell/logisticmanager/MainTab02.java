...
import com.example.dell.logisticmanager.UI.StickyLayout;
		...
		PinnedHeaderExpandableListView.OnHeaderUpdateListener, StickyLayout.OnGiveUpTouchEventListener
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		expandableListView = (PinnedHeaderExpandableListView)messageLayout.findViewById(R.id.expandablelist);
		stickyLayout = (StickyLayout)messageLayout.findViewById(R.id.sticky_layout);
		initData();
